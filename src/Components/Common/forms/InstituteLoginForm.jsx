          ...
          <div class="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
            ...
            <form class="bg-white rounded-md shadow-2xl p-5">
              ...
              <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                ...
                <input id="email" class=" pl-2 w-full outline-none border-none" type="text" name="text" placeholder="Your Full Name" />
              </div>
              <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
              <Book className='opacity-40'/>
                <input id="email" class=" pl-2 w-full outline-none border-none" type="text" name="text" placeholder="Institute Name" />
              </div>
              <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
